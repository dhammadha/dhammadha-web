-- 0029 เขียน admin_upsert_font ใหม่โดยอิงเวอร์ชันก่อน 0020 ทำให้ regression:
-- ใส่ (p_data->>'sale_end')::timestamptz กลับมาทั้งที่คอลัมน์เป็น text
-- ("CASE types text and timestamp with time zone cannot be matched" ตอนบันทึกฟอนต์)
-- ฉบับนี้ = ฟังก์ชันตาม 0020 (sale_end เป็น text, discount_percent::numeric)
-- + คอลัมน์ tester จาก 0029 (obfuscated_font_files, obfuscated_map)
