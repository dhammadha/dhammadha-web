...
0b. **🔴 จดบริษัท (แบบ A) — บล็อก go-live เท่ากับข้อ 0**
   ...
   · **✅ ตอบแล้วทั้งชุด (31 ก.ค. 2569) — เขียนลงสัญญาเรียบร้อย ดู `docs/legal/DRAFT-2569-08.md`**
     ...
     3. **เงินได้ 40(3) ค่าแห่งลิขสิทธิ์ · หัก ณ ที่จ่าย 3%** + ออกใบ 50 ทวิทุกครั้ง
        (`/designer-agreement` ข้อ 6) — ยังต้องทำฝั่งเอกสาร/`payout-doc.ts` ตามเช็คลิสต์ 1b
...
1b. **🔴 หัก ณ ที่จ่ายในเอกสารทุกใบ — ทำตอนจดบริษัท (ข้อ 0b)**
   ...
   · **เช็คลิสต์ตอนจดบริษัท — ต้องแก้ให้ครบทุกข้อ:**
     ...
     6. ~~`/designer-agreement` เพิ่มข้อความว่าจ่ายหลังหักภาษี + ออกใบ 50 ทวิให้~~
        ✅ **เสร็จแล้ว (31 ก.ค. 2569)** — ข้อ 6 ระบุ 40(3) · หัก 3% · ใบ 50 ทวิ · จ่ายรายไตรมาส
