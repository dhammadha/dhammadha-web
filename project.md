...
**Branch:** ทำงานบน `main` สายเดียว — งานถึง `407ecb5` commit แล้วครบ
(เจ้าของ push เองผ่าน GitHub Desktop) · **DB ล้ำหน้าโค้ดบน production อยู่ (0069–0071 apply แล้ว
แต่ยังไม่ deploy)** — ปลอดภัยเพราะโค้ดเก่ายังใช้ RPC เดิมที่ยังอยู่ครบ แต่ **ต้อง deploy ก่อน
ทดสอบ Stripe บน production** ไม่งั้นจะได้ทดสอบโค้ดเก่า
...
---
*อัปเดตล่าสุด: 26 ก.ค. 2026 (ต่อ Stripe จริง + ทดสอบขั้นที่ 1 ผ่าน · ตะกร้าหลายฟอนต์ + `order_items` 0069–0071)*
