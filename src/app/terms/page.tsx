  ...
  return (
    ...
    >
      <LegalSection title="1. ทั่วไป">
        <p>
          เว็บไซต์ dhammadha.com ดำเนินการโดย <strong>ธรรมดาสตูดิโอ</strong> การใช้งานเว็บไซต์ถือว่าคุณ
          ยอมรับข้อกำหนดฉบับนี้ หากไม่เห็นด้วยกรุณายุติการใช้งาน ติดต่อ:{" "}
      ...
      <LegalSection title="3. ทรัพย์สินทางปัญญา">
        ...
        <p>
          ...
          ไฟล์ทดลอง (Demo) ใช้เพื่อการทดสอบก่อนตัดสินใจซื้อเท่านั้น ห้ามใช้ในงานจริงทุกกรณี
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. ข้อจำกัดความรับผิด">
        <p>
          ...
          แต่ไม่รับประกันว่าจะปราศจากข้อผิดพลาดหรือการหยุดชะงัก ความรับผิดของเราจำกัดไม่เกิน
          จำนวนเงินที่คุณชำระสำหรับสินค้าหรือบริการนั้น ๆ
        </p>
      </LegalSection>
