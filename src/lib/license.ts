...
export const LICENSE_LABEL: Record<string, string> = {
  ...
  // "บุคคลธรรมดา" ไม่ใช่ "ส่วนบุคคล" — คำเดิมอ่านได้ว่าห้ามใช้เชิงพาณิชย์ ทั้งที่ความหมายจริง
  // คือผู้ถือสิทธิ์เป็นบุคคลธรรมดา (คู่กับนิติบุคคล = ห้างร้าน องค์กร บริษัท)
  // หน้า /agreement เขียนเต็มว่า "สิทธิการใช้งานสำหรับบุคคลธรรมดา" ให้เข้าคู่บรรทัดสิทธิ์
  // นิติบุคคลที่อยู่ถัดไป ส่วน label ในระบบตัด "สำหรับ" ออกเพราะต้องลงช่องแคบ ๆ ในตะกร้า/อีเมล
  // — ถ้าไม่มีบรรทัดนี้ อีเมลยืนยันคำสั่งซื้อจะโชว์ค่าดิบว่า "personal"
  personal: "สิทธิการใช้งานบุคคลธรรมดา",
 ...
 */
const DOC_LICENSE_HEADLINE = "สิทธิการใช้งานสำหรับ ห้างร้าน องค์กร และบริษัท";
