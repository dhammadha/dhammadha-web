 ...
 *
 * 🔴 **ชื่อแบรนด์เขียนตัวพิมพ์เล็กล้วนเสมอ — "typedee" ไม่ใช่ "Typedee"/"TYPEDEE"**
 * (เจ้าของยืนยัน 8 ส.ค. 2569) ใช้กับทุกที่ที่ชื่อโผล่เป็นข้อความ: หน้าเว็บ · อีเมล ·
 * เอกสาร PDF · **ชื่อแอป/ชื่อหน้าต่าง/ข้อความในแอป desktop** (`desktop/index.html`,
 * `src-tauri/tauri.conf.json` `productName`+`title`, `Cargo.toml` description)
 * ⚠️ กับดัก: ตัวขึ้นต้นประโยคก็ยังเป็นตัวเล็ก และ IDE/สเปลเชกมักแก้เป็น Title Case ให้เอง
 */
