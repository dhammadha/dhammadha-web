...
export default function OwnSettings() {
  const { user } = useAuth();
    ...
    <div className="p-6 max-w-[720px]">
      ...
      <Section title="ข้อมูลผู้ขาย" desc="ใช้แสดงในใบเสนอราคาและใบเสร็จ">
        ...
        <label className="flex items-start gap-2.5 mt-3 cursor-pointer">
          ...
          />
          <div>
            <span className="font-body text-body-sm text-black">จดทะเบียนภาษีมูลค่าเพิ่ม (VAT)</span>
        ...
        <div className="mt-3 pt-3">
          <div className="font-ui text-ui text-black mb-2">ข้อมูลบัญชีธนาคาร</div>
