...
// ที่หน้า /admin/font-review เท่านั้น
export default function OwnFonts({ basePath }: { basePath: "/designer" | "/admin" }) {
  ...
  return (
    <div className="p-6 max-w-[1200px]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button as="link" href={`${basePath}/add`}>
      ...
      <div className="bg-surface">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 gap-3">
            ...
            {tab === "all" && (
              <Button as="link" href={`${basePath}/add`} size="sm">เพิ่มฟอนต์แรก →</Button>
            )}
          </div>
        ) : filtered.map((f) => (
